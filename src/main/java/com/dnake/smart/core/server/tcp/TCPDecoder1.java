 ...
 */
@Deprecated
class TCPDecoder1 extends ByteToMessageDecoder {

	@Override
	protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
//		//logger
//		Log.logger(Category.RECEIVE, "--------------------------------------");
//		Log.logger(Category.RECEIVE, "search data load index[" + in.readerIndex() + "] - [" + (in.readerIndex() + in.readableBytes()) + "]");
...
//		int index = in.indexOf(in.readerIndex(), in.readerIndex() + in.readableBytes() - 1, HEADERS[0]);
//		if (index == -1) {
//			in.clear();
...
//		if (length < LENGTH + MIN_DATA + VERIFY) {
...
//
//		//footer
//		if (in.readByte() == FOOTERS[0] && in.readByte() == FOOTERS[1]) {
